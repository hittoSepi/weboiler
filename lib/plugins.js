...
function catalog(){return installed.map(({id,name,description,version,sections,collections,routePrefix})=>({id,name,description,version,sections,collections,routePrefix}));}
module.exports={clean,cleanSection,renderSection,detail,publicDetail,catalog,types:()=>[...byType.keys()]};
